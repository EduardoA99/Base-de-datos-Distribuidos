...
--5.- Listar el numero de productos por categoria	
	SELECT PC.Name AS Categoria, COUNT(PS.ProductCategoryID) AS Numero_de_Productos
    FROM Production.ProductSubcategory AS PS
	INNER JOIN Production.ProductCategory PC ON PS.ProductCategoryID = PC.ProductCategoryID
	group by PC.Name, PS.ProductCategoryID


--6.- Listar los consumidores que han hecho ordenes durante el año que se especifica
...
--9.- Listar el numero de orden, fecha, vendedor e importe vendido del cliente en especifico
